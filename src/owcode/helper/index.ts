...
declare global {
  ...
  function hudText(
    ...
    textColor: Color,
    reevaluation: HudReeval,
    spectators: SpecVisibility
  ): void;
  /**
   * 创建图标
  ...
  function createIcon(
    ...
    position: Pos,
    icon: Icon,
    reevaluation: IconReeval,
    iconColor: Color,
    showWhenOffscreen: boolean
  ): void;
  /**
   * 创建地图文本
   ...
   * @param value The value used for the modification. For arithmetic operations, this is the second of the two operands, with the other being the variable's existing value. For array operations, this is the value to append or remove.
   */
  function modifyGlobalVarAtIndex(
    variable: string,
    index: number,
    operation: Operation,
    value: any
   ...
   * @param value The value used for the modification. For arithmetic operations, this is the second of the two operands, with the other being the variable's existing value. For array operations, this is the value to append or remove.
   */
  function modifyPlayerVarAtIndex(
    player: Player | Player[],
    variable: string,
    index: number,
    operation: Operation,
  ...
  function setProjectileGravity(
    player: Player | Player[],
    projectileGravityPercent: number
  ): void;
  /**
   * 设置弹道速度
  ...
  function startDamageModification(
    receivers: Player | Player[],
    damagers: Player | Player[],
    damagePercent: number,
    reevaluation: DamageReeval
  ): void;
  /**
   * 开始持续伤害
  ...
  function startHealingModification(
    receivers: Player | Player[],
    healers: Player | Player[],
    healingPercent: number,
    reevaluation: HealingReeval
  ): void;
  /**
   * 开始按下按钮
  ...
  function startRule(
    subroutine: string,
    ifAlreadyExecuting: AsyncBehavior
  ): void;
  /**
   * 开始定向阈值
   ...
   */
  function horizontalAngleTowards(
    player: Player | Player[],
    position: Pos
  ): number;
  /**
   ...
   */
  function getPlayerClosestToReticle(
    player: Player | Player[],
    team: Team
  ): Player;
  /**
   ...
   * @param viewAngle The view angle to compare against in degrees.
   */
  function getPlayersInViewAngle(
    player: Player | Player[],
    team: Team,
    viewAngle: number
  ): Player[];
  ...
  function getNormal(
    startPos: Pos,
    endPos: Pos,
    playersToInclude: Player | Player[],
    playersToExclude: Player | Player[],
    includePlayerOwnedObjects: boolean
  ): Vector;
  /**
   * 射线命中玩家
