...
export const constAlias: { [x: string]: string }  = {
  ...
  'GET_DAMAGE_HEROES': 'DAMAGE_HEROES',
  'GET_ALL_HEROES': 'ALL_HEROES',
  'GET_SUPPORT_HEROES': 'SUPPORT_HEROES',
  'GET_TANK_HEROES': 'TANK_HEROES',
  'GET_CONTROL_SCORING_TEAM': 'CONTROL_SCORING_TEAM',
  'GET_CURRENT_GAMEMODE': 'CURRENT_GAMEMODE',
  'GET_CURRENT_MAP': 'CURRENT_MAP',
}